...
if __name__=='__main__':
    ...
    filename = 'cookie'
    img1_path = os.path.join('my_data', f'{filename}1.jpg') 
    img2_path = os.path.join('my_data', f'{filename}2.jpg')
    ...
    draw_epilines(img1, img2, inlier1, inlier2, F, f'{filename}_epilines.png')
    ...
    # 5. Find the most appropriate solution of the essential matrix
    # 6. Get the 3D points using one of the solutions
    ...
    # 7. get 3D model
    path = os.path.join('output', f'{filename}_reconstructed_scene.obj')
    export_to_obj(best_3d_points[:, :3], output_file=path)
